...
function usage() {
  return [
    ...
    "",
    "--only <ids> narrows validate/build to a comma-separated list of package IDs",
    "instead of every package under plugins/ and iconsets/ — CI uses it to build and publish",
